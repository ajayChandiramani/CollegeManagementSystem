...
$sql="select *from temp where id=$a";
...
<html>
    ...
    <?php $a=$row['studphoto'];
        ...
        <hr class="hr">
        <div class="divs">
            <form method="post" enctype="multipart/form-data" action="approveperform.php">
        ...
        <tr>
            ...
            <tr>
                <td></td>
                <td  height= "30px" width= "500px" ><input type="label" name="enno" hidden="true" class="indesign" required="true" 
